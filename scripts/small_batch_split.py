...
def split_jsonl_file(file_path, batch_size=10, offset=0, method="tot"):
    """
...
split_jsonl_file(
    "/Users/olga/Desktop/Pattern Recognition/Project/X-of-thoughts/outputs/gsm/tot/batch_1_tot_0_101.jsonl"
)
