...
def split_jsonl_file(file_path, batch_size=10, offset=110, method="tot"):
    """
...
split_jsonl_file(
    "/Users/olga/Desktop/Pattern Recognition/Project/X-of-thoughts/outputs/gsm/tot/phi2_tot_110_210.jsonl"
)
