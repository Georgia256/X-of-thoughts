...
#meta_eval_tot
python src/solve.py --tag ${TAG} --range_start ${RANGE_START} --range_end ${RANGE_END} --dataset ${DATASET} --model ${MODEL} --mode metacognitive_eval_tot --data_path outputs/gsm/tot/minibatches/phi_tot_${RANGE_START}_${RANGE_END}.jsonl
