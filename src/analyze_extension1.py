...
if __name__ == "__main__":
    ...
    parser.add_argument("--cot_assertion", default='', type=str)
...
"""
        ...
        for i in range(data_len):
            ...
            if plan_list[0][0] == 'System_of_linear_equations':
                if eot_assertion_data[i]['think/check/eot/flag']:
                    ...
                    steps_sum += 2
                    pec_cnt['p'] += 1
                elif (meta_eval_data[i]['metacognitive_eval/cot/ans'] == cot_data[i]['reason/cot/ans']) and plan_list[1][0] == 'Chain_of_Thought':
                ...
                if meta_eval_data[i]['metacognitive_eval/cot/ans'] == cot_data[i]['reason/cot/ans']:
                    plan_assert_acc += cot_score
                    steps_sum += 1
                    pec_cnt['c'] += 1
                elif eot_assertion_data[i]['think/check/eot/flag'] and plan_list[1][0] == 'System_of_linear_equations':
        ...
        for i in range(data_len):
            if cot_data[i]['reason/cot/score'] == 0:
                if meta_eval_data[i]['metacognitive_eval/cot/ans'] == cot_data[i]['reason/cot/ans']:
                    fp += 1
                else:
                    tn += 1
